...
mixin _$WishlistItem {
 ...
 int get id; int get productId; DateTime get addedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WishlistItem&&(identical(other.id, id) || other.id == id)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.addedAt, addedAt) || other.addedAt == addedAt));
}


@override
int get hashCode => Object.hash(runtimeType,id,productId,addedAt);
...
@useResult
$Res call({
 int id, int productId, DateTime addedAt
});
...
/// Create a copy of WishlistItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? productId = null,Object? addedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int productId,  DateTime addedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WishListItem() when $default != null:
return $default(_that.id,_that.productId,_that.addedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int productId,  DateTime addedAt)  $default,) {final _that = this;
switch (_that) {
case _WishListItem():
return $default(_that.id,_that.productId,_that.addedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int productId,  DateTime addedAt)?  $default,) {final _that = this;
switch (_that) {
case _WishListItem() when $default != null:
return $default(_that.id,_that.productId,_that.addedAt);case _:
  return null;
...
class _WishListItem implements WishlistItem {
  const _WishListItem({required this.id, required this.productId, required this.addedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WishListItem&&(identical(other.id, id) || other.id == id)&&(identical(other.productId, productId) || other.productId == productId)&&(identical(other.addedAt, addedAt) || other.addedAt == addedAt));
}
...
/// Create a copy of WishlistItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? productId = null,Object? addedAt = null,}) {
